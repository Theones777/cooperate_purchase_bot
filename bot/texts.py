...
CUSTOM_DONE_MESSAGE = "Оплата прошла, благодарим! Когда заказ будет готов к выдаче, Вам придет от меня сообщение!"

CUSTOM_NOT_ACCEPTED_MESSAGE = (
    "К сожалению возникла ошибка при проверке оплаты, "
