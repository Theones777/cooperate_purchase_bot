START_ADMIN_MESSAGE = (
    ...
    "/payment_received - Отправка всем сообщения, что оплата получена,\n"
    "/ready_custom - Заказ готова к выдаче,\n"
    "/message_mailing - Отправка всем сообщения,\n"
    "/sync - Синхронизировать данные в базе данных в Гугл-таблицей,\n"
...
CUSTOM_DONE_MESSAGE = "Благодарим за покупку. Когда заказ будет готов к выдаче Вам придет от меня сообщение!"
